  ...
  return (
    <>
      {session?.user.User_info.role === "admin" ? (
        <div className="flex flex-col items-center  min-h-screen  text-5xl mt-10">
          Welcome Admin
          <div className="bg-white p-8 rounded-lg shadow-md w-full max-w-md mt-10 ">
            ...
            <div className="space-y-4">
              <Link href="/manage/provider" className="block w-full">
                <span className="bg-indigo-50 hover:bg-indigo-100 transition-colors duration-300 border border-indigo-200 rounded-md p-4 text-xl text-indigo-700 text-center font-medium">
                  Manage Providers
                </span>
              </Link>
