...
export default function CarPanel(){
    ...
    return (
        ...
        <div>
            ...
            <button className="block rounded-md bg-sky-600 hover:bg-indigo-600 px-3 py-2 text-white shadow-sm" onClick={()=>{countRef.current++;alert(countRef.current);}}>Count with Ref Object</button>
            ...
            <button className="block rounded-md bg-sky-600 hover:bg-indigo-600 px-3 py-2 text-white shadow-sm" onClick={()=>{if(inputRef.current!=null)inputRef.current.focus()}}>Focus text input</button>
        </div>
    )
}