    ...
    <FaFilter />
      ...
      <div className="flex flex-wrap justify-center gap-4 px-4">
        {carJsonReady.data.map((carItem: CarItem, index) => (
          ...
          >
            <div className="overflow-hidden bg-white relative group hover:scale-105 transition-all ease-in-out">
              <ProductCard Name={carItem.name} imgSrc={carItem.picture} price={carItem.pricePerDay} provider={carItem.provider_info.name} />
